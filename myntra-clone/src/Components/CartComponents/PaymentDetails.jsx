...
const PaymentDetails1 = ( {totalMRP,totalMRPDiscount}) => {
...
const PaymentDetails2 = ({ totalAmount,totalMRP,totalMRPDiscount,redirect}) => {
...
export  {PaymentDetails1,PaymentDetails2}
