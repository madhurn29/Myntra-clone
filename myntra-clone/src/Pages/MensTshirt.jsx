                    ...
                    <Box w="100%" h="auto" border={"1px solid gray"} borderTop="none" borderRight="none">
                        ...
                        <Box paddingLeft={"10px"} paddingTop="17px">
                            <Stack spacing={0} direction='column'>
                                <Checkbox colorScheme='pink' value={"Tommy Hilfiger"} onChange={handleChange} defaultChecked={brand.includes("Tommy Hilfiger")}>
                                    Tommy Hilfiger
                                </Checkbox>
                                <Checkbox colorScheme='pink' value={"U.S. Polo Assn."} onChange={handleChange} defaultChecked={brand.includes("U.S. Polo Assn.")}>
                                    U.S. Polo Assn.
                                </Checkbox>
                                <Checkbox colorScheme='pink' value={"Nautica"} onChange={handleChange} defaultChecked={brand.includes("Nautica")}>
                                    Nautica
                                </Checkbox>
                                <Checkbox colorScheme='pink' value={"WROGN"} onChange={handleChange} defaultChecked={brand.includes("WROGN")}>
                                    wrogn
                                </Checkbox>
                                <Checkbox colorScheme='pink' value={"Louis Philippe Sport"} onChange={handleChange} defaultChecked={brand.includes("Louis Philippe Sport")}>
                    ...
                    <Box w="100%" h="auto" border={"1px solid gray"} borderTop="none" borderRight="none">
                        ...
                        <Box paddingLeft={"10px"} paddingTop="17px">
                            <Stack spacing={0} direction='column'>
                                ...
                                <Checkbox colorScheme='pink' >
                                    Olive Green
                                </Checkbox><Checkbox colorScheme='pink' >
                                    Khakee
                                </Checkbox><Checkbox colorScheme='pink' >
                                    Beige
                                </Checkbox>
