            ...
            <Box display={"flex"} >
                ...
                <Box w="20%" h="auto" border={"1px solid gray"} borderRight="none">
                    ...
                    <Box w="100%" h="auto" border={"1px solid gray"} borderTop="none" borderRight="none">
                        ...
                        <Box paddingLeft={"10px"} paddingTop="17px">
                            <Stack spacing={0} direction='column'>
                                <Checkbox colorScheme='pink' value={"Roadster"} onChange={handleChange} defaultChecked={brand.includes("Roadster")}>
                                    Roadster
                                </Checkbox>
                                <Checkbox colorScheme='pink' value={"Levis"} onChange={handleChange} defaultChecked={brand.includes("Levis")}>
                                    Levis
                                </Checkbox>
                                <Checkbox colorScheme='pink' value={"WROGN"} onChange={handleChange} defaultChecked={brand.includes("WROGN")}>
                                    Wrogn
                                </Checkbox>
                                <Checkbox colorScheme='pink' value={"HIGHLANDER"} onChange={handleChange} defaultChecked={brand.includes("HIGHLANDER")}>
                                    HighLander
                                </Checkbox>
                                <Checkbox colorScheme='pink' value={"Mast & Harbour"} onChange={handleChange} defaultChecked={brand.includes("Mast & Harbour")}>
                                    Mast & Harbour
                                </Checkbox>
                                <Checkbox colorScheme='pink' value={"Louis Philippe Jeans"} onChange={handleChange} defaultChecked={brand.includes("Louis Philippe Jeans")}>
                    ...
                    <Box w="100%" h="auto" border={"1px solid gray"} borderTop="none" borderRight="none">
                        ...
                        <Box paddingLeft={"10px"} paddingTop="17px">
                            <Stack spacing={0} direction='column'>
                                <Checkbox colorScheme='pink' defaul>
                                    Rs 500 to Rs 999
                                </Checkbox>
                                <Checkbox colorScheme='pink' defaul>
                                    Rs 1000 to Rs 1299
                    ...
                    <Box w="100%" h="auto" border={"1px solid gray"} borderTop="none" borderRight="none">
                        ...
                        <Box paddingLeft={"10px"} paddingTop="17px">
                            <Stack spacing={0} direction='column'>
                                ...
                                <Checkbox colorScheme='pink' defaul>
                                    Olive Green
                                </Checkbox><Checkbox colorScheme='pink' defaul>
                                    Khakee
                                </Checkbox><Checkbox colorScheme='pink' defaul>
                                    Beige
                                </Checkbox>
