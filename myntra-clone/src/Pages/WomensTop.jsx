                    ...
                    <Box w="100%" h="auto" border={"1px solid gray"} borderTop="none" borderRight="none">
                        ...
                        <Box paddingLeft={"10px"} paddingTop="17px">
                            <Stack spacing={0} direction='column'>
                                <Checkbox colorScheme='pink' onChange={handleChange} value={"SASSAFRAS"} defaultChecked={brand.includes("SASSAFRAS")}>
                                    SASSAFRAS
                                </Checkbox>
                                <Checkbox colorScheme='pink' onChange={handleChange} value={"QUIERO"} defaultChecked={brand.includes("QUIERO")}>
                                    QUIERO
                                </Checkbox>
                                <Checkbox colorScheme='pink' onChange={handleChange} value={"URBANIC"} defaultChecked={brand.includes("URBANIC")}>
                                    URBANIC
                                </Checkbox>
                                <Checkbox colorScheme='pink' onChange={handleChange} value={"Tokyo Talkies"} defaultChecked={brand.includes("Tokyo Talkies")}>
                                    Tokyo Talkies
                                </Checkbox>
                                <Checkbox colorScheme='pink' onChange={handleChange} value={"Vero Moda"} defaultChecked={brand.includes("Vero Moda")}>
                                    Vero Moda
                                </Checkbox>
                                <Checkbox colorScheme='pink' onChange={handleChange} value={"Roadster"} defaultChecked={brand.includes("Roadster")}>
                                    Vero Moda
                                </Checkbox>
                            </Stack>
                        </Box>
                    ...
                    <Box w="100%" h="auto" border={"1px solid gray"} borderTop="none" borderRight="none">
                        ...
                        <Box paddingLeft={"10px"} paddingTop="17px">
                            <Stack spacing={0} direction='column'>
                                ...
                                <Checkbox colorScheme='pink' de>
                                    Olive Green
                                </Checkbox><Checkbox colorScheme='pink' de>
                                    Khakee
                                </Checkbox><Checkbox colorScheme='pink' de>
                                    Beige
                                </Checkbox>
